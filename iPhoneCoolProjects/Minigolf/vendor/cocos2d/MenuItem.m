...
-(id) initFromNormalImage: (NSString*) normalI selectedImage:(NSString*)selectedI disabledImage: (NSString*) disabledI target:(id) t selector:(SEL) sel
{
	...
	normalImage = [[Sprite spriteFromFile:normalI] retain];
	selectedImage = [[Sprite spriteFromFile:selectedI] retain];
    
	if(disabledI == nil)
		disabledImage = nil;
	else
		disabledImage = [[Sprite spriteFromFile:disabledI] retain];
